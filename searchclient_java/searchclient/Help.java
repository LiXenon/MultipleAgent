...
public class Help {
    ...
    public Help(int requesterAgent, int helperAgent, String requesterBox, String blocker, int[] blockerGoalCoordinate, int[] requesterGoalCoordinate, int[] blockerStartCoordinate) {
